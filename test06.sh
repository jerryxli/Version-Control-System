...
# Testing pigs rm works. with flags as well
...
2041 pigs-rm --cached a >> "$REF_OUT" 2>> "$REF_ERR"
...
cat b >> "$REF_OUT" 2>> "$REF_ERR"
cat c >> "$REF_OUT" 2>> "$REF_ERR"
cat d >> "$REF_OUT" 2>> "$REF_ERR"
REF_EXIT=$?
...
pigs-rm --cached a >> "$OUR_OUT" 2>> "$OUR_ERR"
pigs-rm --force b >> "$OUR_OUT" 2>> "$OUR_ERR"
pigs-rm --force c >> "$OUR_OUT" 2>> "$OUR_ERR"
pigs-rm d >> "$OUR_OUT" 2>> "$OUR_ERR"
pigs-show 1:a >> "$OUR_OUT" 2>> "$OUR_ERR"
cat a >> "$OUR_OUT" 2>> "$OUR_ERR"
cat b >> "$OUR_OUT" 2>> "$OUR_ERR"
cat c >> "$OUR_OUT" 2>> "$OUR_ERR"
cat d >> "$OUR_OUT" 2>> "$OUR_ERR"
OUR_EXIT=$?
